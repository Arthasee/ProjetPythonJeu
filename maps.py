...
class Map:
    ...
    def switch_map(self):
        ...
        # default_layer=7 signifie que nous avons défini le calque de base à 7
    ...
    def _load_collisions(self):
        ...
        self.collisions = []
        for obj in self.tmx_data.objects: # on recupére les calques objet a partir des donnés de notre map 
            if obj.type == "collision":
                ...
                self.collisions.append(rect) # on récupere toutes les collisions 
